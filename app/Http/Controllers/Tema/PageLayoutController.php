...
class PageLayoutController extends Controller
{
  ...
  public function layout_collapsed_menu()
  {
    ...
    return view('/tema/content/page-layouts/layout-collapsed-menu', ['pageConfigs' => $pageConfigs, 'breadcrumbs' => $breadcrumbs]);
  }
  ...
  public function layout_boxed()
  {
    ...
    return view('/tema/content/page-layouts/layout-boxed', ['pageConfigs' => $pageConfigs, 'breadcrumbs' => $breadcrumbs]);
  }
  // Layout Without Menu
  public function layout_without_menu()
  {
    ...
    return view('/tema/content/page-layouts/layout-without-menu', ['pageConfigs' => $pageConfigs, 'breadcrumbs' => $breadcrumbs]);
  }
  // Empty Layout
  public function layout_empty()
  {
    $breadcrumbs = [['link' => "/", 'name' => "Home"], ['link' => "javascript:void(0)", 'name' => "Layouts"], ['name' => "Layout Empty"]];
    return view('/tema/content/page-layouts/layout-empty', ['breadcrumbs' => $breadcrumbs]);
  }
  // Blank Layout
  public function layout_blank()
  {
    ...
    return view('/tema/content/page-layouts/layout-blank', ['pageConfigs' => $pageConfigs, 'breadcrumbs' => $breadcrumbs]);
  }
}
