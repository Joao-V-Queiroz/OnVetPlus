<body class="vertical-layout vertical-menu-modern {{ $configData['showMenu'] === true ? '2-columns' : '1-column' }} {{
  ...
  {{-- Include Sidebar --}}
  @if((isset($configData['showMenu']) && $configData['showMenu'] === true)) @include('tema/panels.sidebar') @endif
  ...
  <div class="app-content content {{ $configData['pageClass'] }}">
    ...
    <div class="content-wrapper">
      {{-- Include Breadcrumb --}}
      @if($configData['pageHeader'] == true) @include('tema/panels.breadcrumb') @endif
