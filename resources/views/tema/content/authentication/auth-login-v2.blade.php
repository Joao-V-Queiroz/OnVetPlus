...
@endphp
@extends('tema/layouts/fullLayoutMaster')
...
<div class="auth-wrapper auth-v2">
    <div class="auth-inner row m-0">
        ...
        <a class="brand-logo" href="javascript:void(0);">
            ...
            <h2 class="brand-text text-primary ml-1">Central de Lanches</h2>
        </a>
        <!-- /Brand logo-->
        <!-- Left Text-->
            ...
            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                ...
                <form class="auth-login-form mt-2" action="{{ url('auth/login') }}" method="POST">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="email" type="text" name="email" placeholder="joao@exemplo.com"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-merge form-password-toggle">
                            <input class="form-control form-control-merge" id="senha" type="password" name="senha"
                                placeholder="············" aria-describedby="senha" tabindex="2" />
